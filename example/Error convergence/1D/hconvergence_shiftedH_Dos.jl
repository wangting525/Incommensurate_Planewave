...
plot(vechinv, herror, yaxis=:log, label=[L"\beta=1" L"\beta=0.1"], xlabel=L"h^{-1}", ylabel= "Error", legend= :bottomleft, shape=[:circle :utriangle], markersize=6, lw=3, tickfontsize=15, legendfontsize=15, guidefontsize=15)
